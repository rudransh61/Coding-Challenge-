all = ['beizer', 'blobby','bouncing_ball','4d','cube_projection','flappy_bird','floating_ball',
      'knots','minecraft','pendullum','perlin_blurr','purple_rain','snakes','starfield','terrain','tree_fractal','map','sponge','life','lorenz_attractor','elementary','lsystem','lsystemtriangle','tic-tac-toe']
